...
***[Versions](md_readme_Version_VERSION.html)***, ***[Features](md_readme_Version_FEATURE.html)***,  
***[Namespaces](md_readme_Version_NAMESPACE.html)***, or ***[APIs](md_readme_Version_API.html)***.  
...
Each ***Bug*** must be addressed by an appropriate ***[Fix](md_readme_Version_FIX.html)***, which patches the vulnerability and updates the corresponding software **version**, following the defined  
***[Release Policy](md_readme_Version_RELEASE_POLICY.html)***.  
